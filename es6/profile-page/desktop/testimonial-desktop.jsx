...
import {initialLoad, closeBooking} from '../actions'
...
class TestimonialDesktop extends Component {
  componentDidMount() {
    this.props.dispatch(initialLoad)
  }
  _closeBooking() {
    this.props.dispatch(closeBooking)
  }
  _renderTestimonialDesktop() {
  ...
  render() {
    return (
      ::this._renderTestimonialDesktop()
    );
  }
}

export { TestimonialDesktop };
